...
export async function DELETE(
  ...
  try {
    ...
    await hrUseCases.unassignOrgMember(id);
    return NextResponse.json({ message: "تم إلغاء تعيين العضو بنجاح" });
  } catch (error: any) {
    console.error("Error in DELETE /api/hr/org-members/[id]:", error);
