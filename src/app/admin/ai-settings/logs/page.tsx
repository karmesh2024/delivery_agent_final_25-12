...
import { FiArrowRight, FiList, FiAlertTriangle, FiCheckCircle, FiClock, FiSearch } from 'react-icons/fi';
...
export default function ZoonLogsPage() {
    ...
    <div className="w-full max-w-6xl mx-auto p-4 md:p-6 space-y-6 text-right" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">مراقبة أداء الوكيل والأدوات البرمجية واكتشاف الأخطاء</p>
        </div>
          ...
          <TableBody>
            {loading ? (
              ...
              <TableRow key={log.id}>
                ...
                <TableCell>
                  {log.status === 'success' ? (
                    <Badge className="bg-emerald-50 text-emerald-600 border-emerald-100 gap-1 hover:bg-emerald-50">
