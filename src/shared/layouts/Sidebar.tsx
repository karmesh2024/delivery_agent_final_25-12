...
export function Sidebar() {
  ...
  const mainRoutes = [
    ...
    { name: "الإدارة العامة", href: "/general-management", icon: FiBriefcase },
    { name: "سجل العمليات والمزامنة", href: "/admin/audit-log", icon: FiClipboard },
    ...
    { name: "إدارة العقود", href: "/waste-management/partners/contracts", icon: FiCheckCircle },
